...
void ofxVideoGrabber::drawSettings(){
	settings->draw();
}

//--------------------------------------------------------------------
void ofxVideoGrabber::drawImage(float _x, float _y, float _w, float _h){
	if (bUseTexture){
...
//--------------------------------------------------------------------
void ofxVideoGrabber::drawImage(float _x, float _y){
	drawImage(_x, _y, (float)width, (float)height);
}
